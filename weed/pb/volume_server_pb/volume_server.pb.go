...
type VolumeShrinkPreallocatedRequest struct {
	state    protoimpl.MessageState `protogen:"open.v1"`
	VolumeId uint32                 `protobuf:"varint,1,opt,name=volume_id,json=volumeId,proto3" json:"volume_id,omitempty"`
	// skip when reclaimable space (allocated blocks - logical size) is below this
	MinReclaimBytes uint64 `protobuf:"varint,2,opt,name=min_reclaim_bytes,json=minReclaimBytes,proto3" json:"min_reclaim_bytes,omitempty"`
	// when true, only inspect and report; do not actually shrink
	DryRun        bool `protobuf:"varint,3,opt,name=dry_run,json=dryRun,proto3" json:"dry_run,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *VolumeShrinkPreallocatedRequest) Reset() {
	*x = VolumeShrinkPreallocatedRequest{}
	mi := &file_volume_server_proto_msgTypes[35]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *VolumeShrinkPreallocatedRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*VolumeShrinkPreallocatedRequest) ProtoMessage() {}

func (x *VolumeShrinkPreallocatedRequest) ProtoReflect() protoreflect.Message {
	mi := &file_volume_server_proto_msgTypes[35]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use VolumeShrinkPreallocatedRequest.ProtoReflect.Descriptor instead.
func (*VolumeShrinkPreallocatedRequest) Descriptor() ([]byte, []int) {
	return file_volume_server_proto_rawDescGZIP(), []int{35}
}

func (x *VolumeShrinkPreallocatedRequest) GetVolumeId() uint32 {
	if x != nil {
		return x.VolumeId
	}
	return 0
...
func (x *VolumeShrinkPreallocatedRequest) GetMinReclaimBytes() uint64 {
	if x != nil {
		return x.MinReclaimBytes
	}
	return 0
}

func (x *VolumeShrinkPreallocatedRequest) GetDryRun() bool {
	if x != nil {
		return x.DryRun
	}
	return false
...
type VolumeShrinkPreallocatedResponse struct {
	state                protoimpl.MessageState `protogen:"open.v1"`
	LogicalSize          uint64                 `protobuf:"varint,1,opt,name=logical_size,json=logicalSize,proto3" json:"logical_size,omitempty"`
	AllocatedBytesBefore uint64                 `protobuf:"varint,2,opt,name=allocated_bytes_before,json=allocatedBytesBefore,proto3" json:"allocated_bytes_before,omitempty"`
	AllocatedBytesAfter  uint64                 `protobuf:"varint,3,opt,name=allocated_bytes_after,json=allocatedBytesAfter,proto3" json:"allocated_bytes_after,omitempty"`
	ReclaimedBytes       uint64                 `protobuf:"varint,4,opt,name=reclaimed_bytes,json=reclaimedBytes,proto3" json:"reclaimed_bytes,omitempty"`
	Shrunk               bool                   `protobuf:"varint,5,opt,name=shrunk,proto3" json:"shrunk,omitempty"`
	SkipReason           string                 `protobuf:"bytes,6,opt,name=skip_reason,json=skipReason,proto3" json:"skip_reason,omitempty"`
	// shrink completed (data is on the new inode) but a follow-up step (such
	// as fsync of the parent directory) failed. The new layout will survive a
	// clean shutdown but may not survive an immediate kernel crash.
	DurabilityWarning string `protobuf:"bytes,7,opt,name=durability_warning,json=durabilityWarning,proto3" json:"durability_warning,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}

func (x *VolumeShrinkPreallocatedResponse) Reset() {
	*x = VolumeShrinkPreallocatedResponse{}
	mi := &file_volume_server_proto_msgTypes[36]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *VolumeShrinkPreallocatedResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*VolumeShrinkPreallocatedResponse) ProtoMessage() {}

func (x *VolumeShrinkPreallocatedResponse) ProtoReflect() protoreflect.Message {
	mi := &file_volume_server_proto_msgTypes[36]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use VolumeShrinkPreallocatedResponse.ProtoReflect.Descriptor instead.
func (*VolumeShrinkPreallocatedResponse) Descriptor() ([]byte, []int) {
	return file_volume_server_proto_rawDescGZIP(), []int{36}
}

func (x *VolumeShrinkPreallocatedResponse) GetLogicalSize() uint64 {
	if x != nil {
...
func (x *VolumeShrinkPreallocatedResponse) GetAllocatedBytesBefore() uint64 {
	if x != nil {
		return x.AllocatedBytesBefore
	}
	return 0
}

func (x *VolumeShrinkPreallocatedResponse) GetAllocatedBytesAfter() uint64 {
	if x != nil {
		return x.AllocatedBytesAfter
	}
	return 0
}

func (x *VolumeShrinkPreallocatedResponse) GetReclaimedBytes() uint64 {
	if x != nil {
...
func (x *VolumeShrinkPreallocatedResponse) GetShrunk() bool {
	if x != nil {
		return x.Shrunk
	}
	return false
...
func (x *VolumeShrinkPreallocatedResponse) GetSkipReason() string {
	if x != nil {
		return x.SkipReason
	}
	return ""
...
func (x *VolumeShrinkPreallocatedResponse) GetDurabilityWarning() string {
	if x != nil {
		return x.DurabilityWarning
	}
	return ""
}
...
const file_volume_server_proto_rawDesc = "" +
	...
	"\x12file_deleted_count\x18\x04 \x01(\x04R\x10fileDeletedCount\"\x83\x01\n" +
	"\x1fVolumeShrinkPreallocatedRequest\x12\x1b\n" +
	"\tvolume_id\x18\x01 \x01(\rR\bvolumeId\x12*\n" +
	"\x11min_reclaim_bytes\x18\x02 \x01(\x04R\x0fminReclaimBytes\x12\x17\n" +
	"\adry_run\x18\x03 \x01(\bR\x06dryRun\"\xc0\x02\n" +
	" VolumeShrinkPreallocatedResponse\x12!\n" +
	"\flogical_size\x18\x01 \x01(\x04R\vlogicalSize\x124\n" +
	"\x16allocated_bytes_before\x18\x02 \x01(\x04R\x14allocatedBytesBefore\x122\n" +
	"\x15allocated_bytes_after\x18\x03 \x01(\x04R\x13allocatedBytesAfter\x12'\n" +
	"\x0freclaimed_bytes\x18\x04 \x01(\x04R\x0ereclaimedBytes\x12\x16\n" +
	"\x06shrunk\x18\x05 \x01(\bR\x06shrunk\x12\x1f\n" +
	"\vskip_reason\x18\x06 \x01(\tR\n" +
	"skipReason\x12-\n" +
	"\x12durability_warning\x18\a \x01(\tR\x11durabilityWarning\"\x11\n" +
	...
	"\fVolumeStatus\x12%.volume_server_pb.VolumeStatusRequest\x1a&.volume_server_pb.VolumeStatusResponse\"\x00\x12\x83\x01\n" +
	"\x18VolumeShrinkPreallocated\x121.volume_server_pb.VolumeShrinkPreallocatedRequest\x1a2.volume_server_pb.VolumeShrinkPreallocatedResponse\"\x00\x12S\n" +
...
var file_volume_server_proto_goTypes = []any{
	...
	(*VolumeShrinkPreallocatedRequest)(nil),              // 36: volume_server_pb.VolumeShrinkPreallocatedRequest
	(*VolumeShrinkPreallocatedResponse)(nil),             // 37: volume_server_pb.VolumeShrinkPreallocatedResponse
	(*GetStateRequest)(nil),                              // 38: volume_server_pb.GetStateRequest
	(*GetStateResponse)(nil),                             // 39: volume_server_pb.GetStateResponse
	(*SetStateRequest)(nil),                              // 40: volume_server_pb.SetStateRequest
	(*SetStateResponse)(nil),                             // 41: volume_server_pb.SetStateResponse
	(*VolumeCopyRequest)(nil),                            // 42: volume_server_pb.VolumeCopyRequest
	(*VolumeCopyResponse)(nil),                           // 43: volume_server_pb.VolumeCopyResponse
	(*CopyFileRequest)(nil),                              // 44: volume_server_pb.CopyFileRequest
	(*CopyFileResponse)(nil),                             // 45: volume_server_pb.CopyFileResponse
	(*ReceiveFileRequest)(nil),                           // 46: volume_server_pb.ReceiveFileRequest
	(*ReceiveFileInfo)(nil),                              // 47: volume_server_pb.ReceiveFileInfo
	(*ReceiveFileResponse)(nil),                          // 48: volume_server_pb.ReceiveFileResponse
	(*ReadNeedleBlobRequest)(nil),                        // 49: volume_server_pb.ReadNeedleBlobRequest
	(*ReadNeedleBlobResponse)(nil),                       // 50: volume_server_pb.ReadNeedleBlobResponse
...
var file_volume_server_proto_depIdxs = []int32{
	...
	47,  // 4: volume_server_pb.ReceiveFileRequest.info:type_name -> volume_server_pb.ReceiveFileInfo
	...
	36,  // 43: volume_server_pb.VolumeServer.VolumeShrinkPreallocated:input_type -> volume_server_pb.VolumeShrinkPreallocatedRequest
	38,  // 44: volume_server_pb.VolumeServer.GetState:input_type -> volume_server_pb.GetStateRequest
	40,  // 45: volume_server_pb.VolumeServer.SetState:input_type -> volume_server_pb.SetStateRequest
	42,  // 46: volume_server_pb.VolumeServer.VolumeCopy:input_type -> volume_server_pb.VolumeCopyRequest
	82,  // 47: volume_server_pb.VolumeServer.ReadVolumeFileStatus:input_type -> volume_server_pb.ReadVolumeFileStatusRequest
	44,  // 48: volume_server_pb.VolumeServer.CopyFile:input_type -> volume_server_pb.CopyFileRequest
	46,  // 49: volume_server_pb.VolumeServer.ReceiveFile:input_type -> volume_server_pb.ReceiveFileRequest
	49,  // 50: volume_server_pb.VolumeServer.ReadNeedleBlob:input_type -> volume_server_pb.ReadNeedleBlobRequest
	...
	37,  // 92: volume_server_pb.VolumeServer.VolumeShrinkPreallocated:output_type -> volume_server_pb.VolumeShrinkPreallocatedResponse
	39,  // 93: volume_server_pb.VolumeServer.GetState:output_type -> volume_server_pb.GetStateResponse
	41,  // 94: volume_server_pb.VolumeServer.SetState:output_type -> volume_server_pb.SetStateResponse
	43,  // 95: volume_server_pb.VolumeServer.VolumeCopy:output_type -> volume_server_pb.VolumeCopyResponse
	83,  // 96: volume_server_pb.VolumeServer.ReadVolumeFileStatus:output_type -> volume_server_pb.ReadVolumeFileStatusResponse
	45,  // 97: volume_server_pb.VolumeServer.CopyFile:output_type -> volume_server_pb.CopyFileResponse
	48,  // 98: volume_server_pb.VolumeServer.ReceiveFile:output_type -> volume_server_pb.ReceiveFileResponse
	50,  // 99: volume_server_pb.VolumeServer.ReadNeedleBlob:output_type -> volume_server_pb.ReadNeedleBlobResponse
