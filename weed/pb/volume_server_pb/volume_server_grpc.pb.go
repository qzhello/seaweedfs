...
const (
	...
	VolumeServer_VolumeShrinkPreallocated_FullMethodName    = "/volume_server_pb.VolumeServer/VolumeShrinkPreallocated"
...
type VolumeServerClient interface {
	...
	// shrink an over-preallocated .dat file in place by sparse-copying it
	VolumeShrinkPreallocated(ctx context.Context, in *VolumeShrinkPreallocatedRequest, opts ...grpc.CallOption) (*VolumeShrinkPreallocatedResponse, error)
...
func (c *volumeServerClient) VolumeShrinkPreallocated(ctx context.Context, in *VolumeShrinkPreallocatedRequest, opts ...grpc.CallOption) (*VolumeShrinkPreallocatedResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(VolumeShrinkPreallocatedResponse)
	err := c.cc.Invoke(ctx, VolumeServer_VolumeShrinkPreallocated_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type VolumeServerServer interface {
	...
	// shrink an over-preallocated .dat file in place by sparse-copying it
	VolumeShrinkPreallocated(context.Context, *VolumeShrinkPreallocatedRequest) (*VolumeShrinkPreallocatedResponse, error)
...
func (UnimplementedVolumeServerServer) VolumeShrinkPreallocated(context.Context, *VolumeShrinkPreallocatedRequest) (*VolumeShrinkPreallocatedResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method VolumeShrinkPreallocated not implemented")
}
...
func _VolumeServer_VolumeShrinkPreallocated_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(VolumeShrinkPreallocatedRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(VolumeServerServer).VolumeShrinkPreallocated(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: VolumeServer_VolumeShrinkPreallocated_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(VolumeServerServer).VolumeShrinkPreallocated(ctx, req.(*VolumeShrinkPreallocatedRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var VolumeServer_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "VolumeShrinkPreallocated",
			Handler:    _VolumeServer_VolumeShrinkPreallocated_Handler,
		},
		{
			MethodName: "GetState",
